...
@Component({
  selector: 'app-page-modif-passfn',
  templateUrl: './page-modif-passfn.component.html',
  styleUrls: ['./page-modif-passfn.component.css']
})
export class PageModifPassfnComponent {
  newPassword: string = ''; 
