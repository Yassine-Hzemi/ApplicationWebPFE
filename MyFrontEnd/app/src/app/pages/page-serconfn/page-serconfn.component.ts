...
@Component({
  selector: 'app-page-serconfn',
  templateUrl: './page-serconfn.component.html',
  styleUrls: ['./page-serconfn.component.css']
})
export class PageSerconfnComponent {
  serveur: any;
  serveurArray: any[] = [];
  ...
  Retour() {
    this.router.navigate(['/consultfn']);
