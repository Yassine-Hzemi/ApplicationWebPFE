...
@Component({
  selector: 'app-headerfn',
  templateUrl: './headerfn.component.html',
  styleUrls: ['./headerfn.component.css']
})
export class HeaderfnComponent {
  serveurArray: any[] = [];
...
getAllServers() {
  ...
  onChercherClick() {
    ...
    if (searchedServeur) {
      this.router.navigate(['/barfn'], { state: searchedServeur });
    } else {
